...
class _EditProfileState extends State<EditProfile> {
  ...
  void initState() {
    super.initState();
    dropvalue = widget.currentUser.gender == Genders.Female ? "Nữ" :widget.currentUser.gender == Genders.Male ? "Nam": "Khác";
                      ...
                      Stack(children: <Widget>[
                        ...
                        Positioned(
                            ...
                            child: Container(
                              ...
                              child: IconButton(
                                  color: maincolor, icon: Icon( Icons.camera_enhance_outlined),
                                  onPressed: pickImage ,),
                            ))
                      ])
                    ],
